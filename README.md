# nvim-treesitter-queries-elm

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-elm/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-elm/actions/workflows/validate.yml)

Neovim tree-sitter queries for **elm**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-elm",
...
- [ ] Changes are scoped to `elm` — do not include files for other languages
